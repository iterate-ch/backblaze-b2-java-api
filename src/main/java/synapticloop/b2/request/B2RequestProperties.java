...
public final class B2RequestProperties {
	...
	public static final String KEY_SOURCE_FILE_ID = "sourceFileId";
	public static final String KEY_DESTINATION_BUCKET_ID = "destinationBucketId";
	public static final String KEY_LARGE_FILE_ID = "largeFileId";
	...
	public static final String KEY_PART_RANGE = "range";
